def coffee_bot():
  print('Welcome to old monk cafe!')
...
def order_brewed_coffee():
    res = input("And what kind of flavour for your brewed_coffee? \n[a] Dark \n[b] only milk \n[c] no sugar \n>")
    if res == 'a':
        return 'Dark brewed_coffee'
    elif res == 'b':
        return 'only milk brewed_coffee'
    elif res == 'c':
        return 'no sugar brewed_coffee'
    else:
        print_message()
